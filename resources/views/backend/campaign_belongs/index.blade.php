        ...
        <div class="d-flex flex-column-fluid">
            <div class="container">
                <div class="card card-custom">
                    @include('backend.includes.card.header', ['page' => 'campaign_belongs'])
                    <div class="card-body">
...
@section('scripts')
    ...
    @include('backend.includes.plugins.datatable',['columns'=>['id','name','status','actions'], 'route'=>route('backend.campaign_belongs.index')])
@endsection
