...
<div class="table-responsive">
        <table class="table table-hover table-rounded border gy-7 gs-7">
            <tbody>
                <tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-200">
                    ...
                    <td class="table-center">{{ $brand->id }}</td>
                </tr>
                <tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-200">
                ...
                @if(!is_null($brand->transtext))
                <tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-200">
                    <td class="table-row-title w-25">
                        @lang('backend.labels.content')
                    </td>
                    <td class="table-center">{!! strip_tags($brand->transtext) !!}</td>
                </tr>
                @endif
                <tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-200">
                    ...
                    <td class="table-center">
                        ...
                        @include('backend.includes.modal.image',['model' => $brand,'image_path'=>$brand->getFirstImageAttribute()?: asset('backend/img/noimage.jpg')])
                    </td>
                </tr>
                ...
                <tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-200">
                    ...
                    <td class="table-center">{!! badge($brand->status) !!}</td>
                </tr>
                ...
                <tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-200">
                    ...
                    <td class="table-center">{{ $brand->created_at->format('d-m-Y H:i:s') }}</td>
                </tr>
                ...
                <tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-200">
                    ...
                    <td class="table-center">{{ $brand->updated_at->format('d-m-Y H:i:s') }}</td>
                </tr>
    ...
    <table class="table table-hover table-rounded border gy-7 gs-7">
        ...
        <tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-200">
            ...
            <td class="table-center">{{ translation_first($brand)->meta_title ?? ''  }}</td>
        </tr>
        <tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-200">
            <td class="table-row-title w-25">
                @lang('backend.labels.keywords')
            </td>
            <td class="table-center">{{ translation_first($brand)->meta_keywords ?? ''  }}</td>
        </tr>
        <tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-200">
            <td class="table-row-title w-25">
                @lang('backend.labels.description')
            </td>
            <td class="table-center">{{ translation_first($brand)->meta_description ?? ''  }}</td>
        </tr>
        </tbody>
    </table>
    </div>
