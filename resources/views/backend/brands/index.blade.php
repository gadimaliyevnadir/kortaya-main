        ...
        <div class="d-flex flex-column-fluid">
            <div class="container">
                <div class="card card-custom">
                    @include('backend.includes.card.header', ['page' => 'brands'])
                    @include('backend.brands.tables.index')
                </div>
            </div>
        </div>
    </div>
...
@section('scripts')
    ...
    @include('backend.includes.plugins.datatable',['columns'=>['id','image','name','description','status','actions'], 'route'=>route('backend.brands.index')])
@endsection
