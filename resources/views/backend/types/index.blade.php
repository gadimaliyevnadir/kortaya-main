        ...
        <div class="d-flex flex-column-fluid">
            <div class="container">
                <div class="card card-custom">
                    @include('backend.includes.card.header', ['page' => 'types'])
                    @include('backend.types.tables.index')
                </div>
            </div>
        </div>
    </div>
...
@section('scripts')
    ...
    @include('backend.includes.plugins.datatable',['columns'=>['id','name','created_at','status','actions'], 'route'=>route('backend.types.index')])
@endsection
