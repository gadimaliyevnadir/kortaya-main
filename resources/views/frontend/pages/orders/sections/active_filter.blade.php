<div class="order_tracking_date_box" data-assign="active">
    <form action="{{ route('frontend.orderTracking',['type'=>'active']) }}" method="post">
        @csrf
        <div class="order_tracking_date_box_div">
            <select name="orderTrackingSelect" id="ordertrackingselect">
                @foreach(\App\Enums\OrderType::getInstances() as $orderType)
            ...
            <ul class="order_tracking_time_duration">
                <li class="order_tracking_time_duration_item">
                    <a class="order_tracking_time_duration_link data_change_input_active"
            ...
            <div class="order_tracking_date">
                <div class="order_tracking_date_item">
                    <input type="text" id="simple" name="from" class="order_tracking_date_class data_change_input_active_value"/>
                    <label for="simple">
        ...
        <ul class="order_tracking_date_info">
            ...
            <li class="order_tracking_date_info_item">
                You can check order history of orders that have been fulfilled over 36 months ago in tab.
            </li>
        </ul>
    </form>
</div>
